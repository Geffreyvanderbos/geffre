...
export function initLiteLight(options = {}) {
  ...
  document.addEventListener("click", (e) => {
    ...
    if (
      ...
      !e.target.hasAttribute(config.imageUrlAttribute)
    )
      return;
    ...
    function navigateToImage(index) {
      ...
      const nextImageUrl = images[currentIndex].getAttribute(
        config.imageUrlAttribute,
      );
    ...
    function handleTouchEnd(e) {
      ...
      if (
        ...
        if (
          ...
          navigateToImage(
            swipeDistanceX > 0 ? currentIndex - 1 : currentIndex + 1,
          );
    ...
    lightboxImage.src = images[currentIndex].getAttribute(
      config.imageUrlAttribute,
    );
    lightboxImage.classList.add("lite-light-fade-in");
